                ...
                function getLocation(){
					...
					document.getElementById("locationP").innerHTML='正在获取位置信息...';
						...
						longitude= 119.28583;//position.coords.longitude;//经度
						latitude= 25.70891;//position.coords.latitude;//维度
						accuracy= 10;//position.coords.accuracy;//精确度
